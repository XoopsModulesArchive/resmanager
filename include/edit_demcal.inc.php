 <?php
    ...
    $my_form = new XoopsThemeForm(_MD_TITLE_TITLE_NODEM.' '.$iddem, "editdemcal", "edit_demcal.php");
    ...
    $my_form->addElement(new XoopsFormLabel(_MD_DATEHEURE_RESERV,""));
	foreach ( $tab_demcal as $key_demcal=>$dem_cal )
	{
	  $my_form->addElement(new XoopsFormLabel("",affDate($dem_cal['year_demcal'], $dem_cal['month_demcal'], $dem_cal['day_demcal'], $dem_cal['time_demcal'])));
	}
